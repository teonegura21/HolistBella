        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'fade-in-up' : ''}`}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 stagger-4">
            ...
            <Button
              ...
              className="border-2 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black backdrop-blur-sm px-10 py-5 text-lg transition-all duration-300 font-semibold"
            >
