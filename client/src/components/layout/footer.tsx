    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">Holist Bella</h3>
            <p className="text-gray-400 mb-4 leading-relaxed">
              Centrul de sănătate holistică din Iași, dedicat echilibrului și vindecării naturale 
              prin medicina alternativă.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>
            &copy; 2024 Holist Bella. Toate drepturile rezervate. | 
            <button className="hover:text-white transition-colors ml-1">Politica de Confidențialitate</button> | 
            <button className="hover:text-white transition-colors ml-1">Cookie Policy</button>
          </p>
        </div>
      </div>
    </footer>
